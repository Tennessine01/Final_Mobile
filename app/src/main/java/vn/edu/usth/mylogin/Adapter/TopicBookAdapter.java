...
public class TopicBookAdapter extends RecyclerView.Adapter<TopicBookAdapter.ViewHolder> {

    private ArrayList<BookDomain> items;
    private Context context;

    public TopicBookAdapter() {
        this.items = new ArrayList<>();
    }
    public TopicBookAdapter(ArrayList<BookDomain> items) {
        this.items = items;
    }
    @Override
